...
# Escala global de tipografía (1.0 = tamaño base). Sube/baja en pasos de 0.05.
FONT_SCALE = 1.05

URL_INSTAGRAM = "https://www.instagram.com/ela.food2024?igsh=MXU2cWs5cWkyMTg0Yg=="
URL_FACEBOOK = "https://www.facebook.com/share/1BiVtmfn9c/?mibextid=wwXIfr"
# WhatsApp sin + para wa.me
URL_WHATSAPP = "https://wa.me/15619004479"
...
INTRO_POSTRES_ESPECIALIDADES = (
    "Disponibles solo por encargo.\n\nCada pedido se prepara con anticipación para garantizar frescura y calidad."
)

TEXTO_AYUDA_CARRITO = (
    "Mira en el **Carrito** **»** arriba a la izquierda para abrir el **menú lateral**: "
    "allí verás tu **Pedido**; agrega productos, tus datos, elige **O → WSP** o **O → SMS** "
